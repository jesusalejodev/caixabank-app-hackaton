        ...
        <Container sx={{ mt: 10, mb: 4 }}>
            ...
            <Box sx={{ mt: 8 }}>
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={6} md={2} id="accounts">
                    ...
                    <Grid item xs={12} sm={6} md={2} id="movements">
                        <Card sx={{ p: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Grid item xs={12} sm={6} md={2} id="transfers">
                        <Card sx={{ p: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Grid item xs={12} sm={6} md={2}  id="brokers">
                        <Card sx={{ p: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
