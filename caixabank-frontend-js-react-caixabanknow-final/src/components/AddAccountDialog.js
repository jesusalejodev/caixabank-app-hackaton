...
const AddAccountDialog = ({ open, setOpen, setSnackbarOpen, onAddAccount }) => {
    ...
    const validateForm = () => {
        ...
        if (!accountBalance || isNaN(Number(accountBalance))) errors.balance = "Balance must be a valid number";
        if (Number(accountBalance) < 0) errors.balance = "Balance cannot be negative";
